...
//TODO No clue what positions this class needs so this needs to be done. the values there rn are garbage values, delete them when you get the right ones.
public enum OuttakePivotPosition {
    ...
    OuttakePivotPosition(double targetPosition) {
