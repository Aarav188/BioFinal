...
public class BucketAuto extends BaseOpMode{
    ...
    public void runOpMode(){
        ...
        TrajectoryActionBuilder moveToFirstGroundSpecAndDrop = initialSpecDrop.endTrajectory().fresh()
                ...
                .afterDisp(3, new ParallelAction(new DepoArmReset(outtakePivotSubsystem), new AutoDepoWristReset(outtakeClawSubsystem)))
                .afterDisp(10, new ParallelAction(new AutoElevatorDownCommand(elevatorSubsystem)))
                .splineToLinearHeading(new Pose2d(-48, -41, Math.toRadians(80)), Math.toRadians(80)) //pickup second sample
                ...
                .afterDisp(0, new ParallelAction(new IntakeServosToGround(intakeSubsystem), new Intake(intakeSubsystem)))
                .afterDisp(3, new ParallelAction(new DepoArmReset(outtakePivotSubsystem), new AutoDepoWristReset(outtakeClawSubsystem)))
                .afterDisp(10, new AutoElevatorDownCommand(elevatorSubsystem))
                //.lineToY(-45)
                ...
                .afterDisp(5, new ParallelAction(new ExtendoOut(extendoSubsystem), new IntakeStopperDown(intakeSubsystem)))
                .setTangent(-90)
                .splineToLinearHeading(new Pose2d(-62,-56, Math.toRadians(100)), Math.toRadians(135)) //drop off third sample
                .stopAndAdd(new OuttakeUnlockSample(outtakeClawSubsystem))
                .waitSeconds(1)
                ...
                .afterDisp(3, new ParallelAction(new DepoArmReset(outtakePivotSubsystem), new AutoDepoWristReset(outtakeClawSubsystem)))
                .afterDisp(10, new AutoElevatorDownCommand(elevatorSubsystem))
                .splineToLinearHeading(new Pose2d(-57, -44, Math.toRadians(110)), Math.toRadians(110)) //pickup 4th sample
