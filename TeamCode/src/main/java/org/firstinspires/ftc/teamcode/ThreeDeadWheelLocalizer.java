...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1457.3447957926285; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1454.3447957926285; // y position of the second parallel encoder (in tick units)
